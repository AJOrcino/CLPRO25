        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center py-4 lg:py-6 space-y-4 lg:space-y-0">
          ...
          {showBackButton && (
            <div className="flex items-center">
              <Link 
                to={backTo}
                className="inline-flex items-center space-x-2 px-4 py-2 bg-white/10 hover:bg-white/20 text-white/90 hover:text-white rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg group"
              >
          ...
          <div className="flex items-center space-x-4 lg:space-x-6">
            ...
            <div className="flex items-center space-x-3 lg:space-x-4 bg-white/5 backdrop-blur-sm rounded-2xl px-4 py-3 border border-white/10 hover:bg-white/10 transition-all duration-300 group">
              <div className="text-right space-y-1">
                <p className="text-sm lg:text-base font-semibold text-white group-hover:text-blue-100 transition-colors">Admin User</p>
                <p className="text-xs lg:text-sm text-blue-200/70 group-hover:text-blue-200/90 transition-colors">Administrator</p>
              </div>
              <div className="relative group/avatar">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full blur-md opacity-50 group-hover/avatar:opacity-75 transition-opacity duration-300"></div>
                <div className="relative h-10 w-10 lg:h-12 lg:w-12 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full flex items-center justify-center shadow-xl group-hover/avatar:shadow-2xl transition-all duration-300 group-hover/avatar:scale-105">
